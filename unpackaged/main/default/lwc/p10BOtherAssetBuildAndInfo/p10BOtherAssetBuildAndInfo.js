...
import getCustomDatatableCompInput from "@salesforce/apex/P10BOtherAssetBuildAndInfo.getCustomDatatableCompInput";
import getConfirmationMessageOnNext from "@salesforce/apex/Utils.getConfirmationMessageOnNext";
import saveSiteMetadataRecords from "@salesforce/apex/P10BOtherAssetBuildAndInfo.saveSiteMetadataRecords";
import findNextPromptId from "@salesforce/apex/P10BOtherAssetBuildAndInfo.findNextPromptId";
...
import p10BValidationErrorOnDataSave from '@salesforce/label/c.P10BValidationErrorOnDataSave';
...
import clearPromptInfo from "@salesforce/apex/P10BOtherAssetBuildAndInfo.clearPromptInfo";
...
export default class P10BOtherAssetBuildAndInfo extends LightningElement {
    @api plantAssetId;
    @api attrHlVal;
    @api isBulkUpload;
            ...
            JSON.parse(attrInfoJSON, (attrJSONKey, attrJSONValue) => {
                ...
                if (attrJSONKey === 'Device Name') {
                    ...
                    if ((isEmptyOrSpaces(parsedAttrValue))) {
                        ...
                        showAndHideSpinner(this, 'hidespinner');
                        showToast(this, p10BValidationErrorOnDataSave, 'Error', 'error', this.toastMessageMode);
                    }
                    if (!(isEmptyOrSpaces(parsedAttrValue))) {
