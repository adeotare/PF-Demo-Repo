...
import getCustomDatatableCompInput from "@salesforce/apex/W5ATurbineBuildSubsystems.getCustomDatatableCompInput";
import saveSiteMetadataRecords from "@salesforce/apex/W5ATurbineBuildSubsystems.saveSiteMetadataRecords";
import findNextPromptId from "@salesforce/apex/W5ATurbineBuildSubsystems.findNextPromptId";
...
import clearPromptInfo from "@salesforce/apex/W5ATurbineBuildSubsystems.clearPromptInfo";
...
import w5ADeviceNameIsBlankMessage from '@salesforce/label/c.W5ADeviceNameIsBlank';
...
export default class W5ATurbineBuildSubsystems extends LightningElement {
      ...
      JSON.parse(attrInfoJSON, (attrJSONKey, attrJSONValue) => {
        if (attrJSONKey === 'Device Name') {
          ...
          if ((isEmptyOrSpaces(parsedAttrValue))) {
            ...
            showAndHideSpinner(this, 'hidespinner');
            showToast(this, w5ADeviceNameIsBlankMessage, 'Error', 'error', this.toastMessageMode);
          }
          if (!(isEmptyOrSpaces(parsedAttrValue))) {
