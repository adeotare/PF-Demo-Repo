...
import getCustomDatatableCompInput from "@salesforce/apex/P8BInvertersCombinerInfo.getCustomDatatableCompInput";
import saveSiteMetadataRecords from "@salesforce/apex/P8BInvertersCombinerInfo.saveSiteMetadataRecords";
import findNextPromptId from "@salesforce/apex/P8BInvertersCombinerInfo.findNextPromptId";
...
import p8BCombinerIsBlankMsg from '@salesforce/label/c.P8BCombinerIsBlankMsg';
import clearPromptInfo from "@salesforce/apex/P8BInvertersCombinerInfo.clearPromptInfo";
...
export default class P8BInvertersCombinerInfo extends LightningElement {
  @api plantAssetId;
  ...
  validation() {
    ...
    this.siteMetadataIdToRecordDetails.forEach((value, key) => {
      ...
      JSON.parse(attrInfoJSON, (attrJSONKey, attrJSONValue) => {
        if (attrJSONKey === 'Combiner Name') {
          if (isEmptyOrSpaces(attrJSONValue)) {
            showAndHideSpinner(this, 'hidespinner');
            showToast(this, p8BCombinerIsBlankMsg, 'Error', 'error', this.toastMessageMode);
            isValid = false;
          }
    ...
    return (uniqueValueCheck) ? isValid : false;
  }
