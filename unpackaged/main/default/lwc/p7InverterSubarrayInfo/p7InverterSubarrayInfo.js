...
import getCustomDatatableCompInput from "@salesforce/apex/P7InverterSubarrayInfo.getCustomDatatableCompInput";
import P7ValidationErrorOnDataSave from "@salesforce/label/c.P7ValidationErrorOnDataSave";
...
import findNextPromptId from "@salesforce/apex/P7InverterSubarrayInfo.findNextPromptId";
import saveSiteMetadataRecords from "@salesforce/apex/P7InverterSubarrayInfo.saveSiteMetadataRecords";
...
import clearPromptInfo from '@salesforce/apex/P7InverterSubarrayInfo.clearPromptInfo';
...
export default class P7InverterSubarrayInfo extends LightningElement {
  @api plantAssetId;
  ...
  validation() {
    ...
    this.siteMetadataIdToRecordDetails.forEach((value, key) => {
      ...
      JSON.parse(attrInfoJSON, (attrJSONKey, attrJSONValue) => {
        if (attrJSONKey === 'Subarray Name') {
          if (attrJSONValue.trim() === '') {
            showToast(this, P7ValidationErrorOnDataSave, 'Error', 'error', this.toastMessageMode);
            showAndHideSpinner(this, 'hidespinner');
            validCheck = false;
          }
