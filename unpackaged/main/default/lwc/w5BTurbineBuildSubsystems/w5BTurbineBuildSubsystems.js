...
import getCustomDatatableCompInput from "@salesforce/apex/W5BTurbineBuildSubsystems.getCustomDatatableCompInput";
import saveSiteMetadataRecords from "@salesforce/apex/W5BTurbineBuildSubsystems.saveSiteMetadataRecords";
import findNextPromptId from "@salesforce/apex/W5BTurbineBuildSubsystems.findNextPromptId";
import querySiteMetadata from "@salesforce/apex/Utils.querySortedSiteMetadata";
import clearPromptInfo from "@salesforce/apex/W5BTurbineBuildSubsystems.clearPromptInfo";
...
import w5BDeviceNameIsBlankMessage from '@salesforce/label/c.W5BDeviceNameIsBlank';
...
export default class W5BTurbineBuildSubsystems extends LightningElement {
      ...
      JSON.parse(attrInfoJSON, (attrJSONKey, attrJSONValue) => {
        if (attrJSONKey === 'Device Name') {
          ...
          if ((isEmptyOrSpaces(parsedAttrValue))) {
            ...
            showAndHideSpinner(this, 'hidespinner');
            showToast(this, w5BDeviceNameIsBlankMessage, 'Error', 'error', this.toastMessageMode);
          }
          if (!(isEmptyOrSpaces(parsedAttrValue))) {
