...
import getCustomDatatableCompInput from "@salesforce/apex/P9ATrackerControllerInfo.getCustomDatatableCompInput";
import clearPromptInfo from "@salesforce/apex/P9ATrackerControllerInfo.clearPromptInfo";
...
import findNextPromptId from "@salesforce/apex/P9ATrackerControllerInfo.findNextPromptId";
...
import saveSiteMetadataRecords from "@salesforce/apex/P9ATrackerControllerInfo.saveSiteMetadataRecords";
...
import p9AValidationErrorOnDataSave from '@salesforce/label/c.P9AValidationErrorOnDataSave';
...
export default class P9ATrackerControllerInfo extends LightningElement {
    @api plantAssetId;
    ...
    */	
    ...
    validation(){ 
        ...
        this.siteMetadataIdToRecordDetails.forEach((value, key) => {
            ...
            if(attrJSONKey === 'Tracker Controller Name'){
                if(attrJSONValue.trim() === ''){
                    showToast(this, p9AValidationErrorOnDataSave, 'Error', 'error', this.toastMessageMode);
                    showAndHideSpinner(this, 'hidespinner');
                    validCheck = false;
                }
